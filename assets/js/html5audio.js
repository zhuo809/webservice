...
var myaudioURL = 'http://94.23.215.165:3090/;stream.mp3';
//var myaudio = new Media(myaudioURL, onSuccess, onError);
var myaudio = new Media(url,
        // success callback
...
var html5audio = {
	play: function()
	{
		...
		myaudio.addEventListener("timeupdate", function() {
			 var s = parseInt(myaudio.getDuration % 60);
			 var m = parseInt((myaudio.getDuration / 60) % 60);
			 var h = parseInt(((myaudio.getDuration / 60) / 60) % 60);
			 if (isPlaying && myaudio.getDuration > 0) {
